...
// Core function to get the details of the currently playing item
...
// This is the API route handler (Next.js App Router style)
export async function GET() {
  const nowPlaying = await getNowPlayingItem()
  // If no song is playing, return { isPlaying: false }
