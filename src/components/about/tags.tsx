export function C({ ...props }) {
  return (
    <div className="flex items-center gap-1">
      ...
      <h3 className="text-md mr-2 flex font-normal">C</h3>
    </div>
  )
}
...
export function Cpp({ ...props }) {
  return (
    <div className="flex items-center gap-1">
      ...
      <h3 className="text-md flex font-normal">C++</h3>
    </div>
  )
}
...
export function Swift({ ...props }) {
  return (
    <div className="flex items-center gap-1">
      ...
      <h3 className="text-md flex font-normal">Swift</h3>
    </div>
  )
}

export function SwiftUI({ ...props }) {
  return (
    <div className="flex items-center gap-1">
      ...
      <h3 className="text-md flex font-normal">SwiftUI</h3>
    </div>
  )
}

export function Unix({ ...props }) {
  return (
    <div className="flex items-center gap-1">
      <svg {...props} version="1.0" viewBox="0 0 891 752" xmlns="http://www.w3.org/2000/svg">
      ...
      <h3 className="text-md flex font-normal">Unix</h3>
    </div>
  )
}
...
export function Linux({ ...props }) {
  return (
    <div className="flex items-center gap-1">
      <svg xmlns="http://www.w3.org/2000/svg" version="1.0" viewBox="0 0 266 312" {...props}>
      ...
      <h3 className="text-md flex font-normal">Linux</h3>
    </div>
  )
}
...
export function Macos({ ...props }) {
  return (
    <div className="flex items-center gap-1">
      ...
      <h3 className="text-md flex font-normal">macOS</h3>
    </div>
  )
}
...
export function Nodejs({ ...props }) {
  return (
    <div className="flex items-center gap-1">
      ...
      <h3 className="text-md flex font-normal">Node.js</h3>
    </div>
  )
}

export function Expressjs({ ...props }) {
  return (
    <div className="flex items-center gap-1">
      <svg
        xmlns="http://www.w3.org/2000/svg"
      ...
      <h3 className="text-md flex font-normal">Express.js</h3>
    </div>
  )
}
...
export function Python({ ...props }) {
  return (
    <div className="flex items-center gap-1">
      ...
      <h3 className="text-md flex font-normal">Python</h3>
    </div>
  )
}
...
export function Tailwindcss({ ...props }) {
  return (
    <div className="flex items-center gap-1">
      ...
      <h3 className="text-md flex font-normal">TailwindCSS</h3>
    </div>
  )
}
...
export function NextJS({ ...props }) {
  return (
    <div className="flex items-center gap-1">
      <svg viewBox=".5 -.2 1023 1024.1" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <h3 className="text-md flex font-normal">Next.js</h3>
    </div>
  )
}
...
export function Arduino({ ...props }) {
  return (
    <div className="flex items-center gap-1">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1372.201 1372.684" {...props}>
        <path
          fill="#00979D"
          stroke="#81C9CB"
          strokeWidth=".932"
      ...
      <h3 className="text-md flex font-normal">Arduino</h3>
    </div>
  )
}
